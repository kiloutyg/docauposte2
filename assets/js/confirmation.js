...
//         confirmationHandler(event, 'Êtes vous sûr de vouloir supprimer cette Zone?');
//       });
//     });

//     deleteProductLineButtons.forEach((button) => {
//       button.addEventListener('click', (event) => {
//         confirmationHandler(event, 'Êtes vous sûr de vouloir supprimer cette Ligne?');
//       });
//     });
//     deleteCategoryButtons.forEach((button) => {
//         button.addEventListener('click', (event) => {
//           confirmationHandler(event, 'Êtes vous sûr de vouloir supprimer cette categorie?');
//         });
//       });
//       deleteButtonButtons.forEach((button) => {
//         button.addEventListener('click', (event) => {
//           confirmationHandler(event, 'Êtes vous sûr de vouloir supprimer ce Bouton?');
//         });
//       });
//       deleteUserButtons.forEach((button) => {
//         button.addEventListener('click', (event) => {
//           confirmationHandler(event, 'Êtes vous sûr de vouloir supprimer cet Utilisateur?');
//         });
//       });
//       deleteUploadButtons.forEach((button) => {
//         button.addEventListener('click', (event) => {
//           confirmationHandler(event, 'Êtes vous sûr de vouloir supprimer ce Document?');
//         });
//       });
//   });
document.addEventListener("DOMContentLoaded", () => {
